...
export function MdiCardsHeartRed(props) {
  return (
    <svg width="1.5rem" height="1.5rem" viewBox="0 0 24 24" {...props}>
      <path
        d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.27 2 8.5C2 5.41 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.08C13.09 3.81 14.76 3 16.5 3C19.58 3 22 5.41 22 8.5c0 3.77-3.4 6.86-8.55 11.53L12 21.35z"
...
export function MdiCartOutline(props) {
  return (
    <svg width="1.5rem" height="1.5rem" viewBox="0 0 24 24" {...props}>
      <path
...
export function IcBaselineStar(props) {
  return (
...
export function IcBaselineStarBorder(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
...
export function BxBxRupee(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
...
export function IcRoundSort(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
...
export function IlArrowUp(props) {
  return (
    <svg width="0.9em" height="1em" viewBox="0 0 630 700" {...props}>
      <path
...
export function MdiLogin(props) {
  return (
    <svg width="1.5rem" height="1.5rem" viewBox="0 0 24 24" {...props}>
      <path
...
export function IcBaselineAdd(props) {
  return (
    <svg width="0.8rem" height="0.8rem" viewBox="0 0 24 24" {...props}>
      <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" fill="currentColor"></path>
    </svg>
  );
}

export function IcBaselineRemove(props) {
  return (
    <svg width="0.8rem" height="0.8rem" viewBox="0 0 24 24" {...props}>
...
export function BxBxsHide(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
